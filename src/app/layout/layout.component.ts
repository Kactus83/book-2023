...
@Component({
    ...
    standalone   : true,
    imports      : [NgIf, EmptyLayoutComponent, MinimalLayoutComponent, SettingsComponent],
})
export class LayoutComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        ...
        private _fusePlatformService: PlatformService,
    )
    {
    }
    ...
    ngOnInit(): void
    {
        ...
        // Set the app version
        this._renderer2.setAttribute(this._document.querySelector('[ng-version]'), 'fuse-version', CORE_VERSION);
